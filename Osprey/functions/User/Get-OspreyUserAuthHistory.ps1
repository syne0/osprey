...
.EXAMPLE
    ...
    Get-OspreyUserAuthHistory -UserPrincipalName user@contoso.com -ResolveIPLocations
...
.EXAMPLE
    ...
    Get-OspreyUserAuthHistory -UserPrincipalName (get-mailbox -Filter {Customattribute1 -eq "C-level"}) -ResolveIPLocations
