Function Get-OspreyUserMobileDevice { #TODO: determine if this just grabs 'mobile devices'? When I really wanna see is any Azure/Entra/Intune registered or joined stuff!
<#
.SYNOPSIS
